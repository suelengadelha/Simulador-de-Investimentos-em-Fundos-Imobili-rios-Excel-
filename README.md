# Simulador de Investimentos em Fundos Imobiliarios Excel

_Ferramenta prática para simulação de investimentos em Fundos Imobiliários (FIIs)_
...
A partir da compreensão do funcionamento dos FIIs e das principais dúvidas de investidores — como quanto investir, por quanto tempo, taxa de rendimento e retorno esperado — foi desenvolvida uma planilha que automatiza cálculos financeiros e auxilia na tomada de decisões mais informadas.

A solução permite simular cenários de investimento, calculando automaticamente:
...
✅ Automatizar cálculos complexos para facilitar análises financeiras
